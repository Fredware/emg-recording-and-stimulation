...
try
    addpath(regexprep(pwd, "matlab-scripts", "mujoco\\apimex"))
    hx_close
    hx_connect('')
    disp(hx_robot_info)

    % Set up inital configuration of the hand
    joint_positions = [ 0; ...     %(01) wrist pronation/supination
    ...
    % indices
    joint_groups = struct( 'all_fingers', [5, 6, 7, 8, 9, 10, 11, 12, 13], ...
        'wrist_flexion', [3]);
